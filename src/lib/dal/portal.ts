...
const COMMERCES_MOCK: Record<string, Commerce> = {
  'c1': {
    ...
    logoUrl: '/images/city-colon.jpg',
    coverUrl: '/images/city-colon.jpg',
  ...
  'c2': {
    ...
    isVerified: true,
    isSubscriptionActive: true,
    logoUrl: '/images/city-parana.jpg',
    coverUrl: '/images/city-parana.jpg',
  ...
  'c3': {
    ...
    isVerified: true,
    isSubscriptionActive: true,
    logoUrl: '/images/offer-6.jpg',
    coverUrl: '/images/offer-6.jpg',
  ...
  'c4': {
    ...
    isVerified: true,
    isSubscriptionActive: true,
    logoUrl: '/images/city-chajari.jpg',
    coverUrl: '/images/city-chajari.jpg',
