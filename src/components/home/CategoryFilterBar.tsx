  ...
  return (
    <div className="bg-white rounded-3xl p-4 sm:p-5 border border-slate-200 shadow-xs space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-xs font-extrabold uppercase tracking-widest text-[#0047BA] flex items-center gap-1.5">
          <LayoutGrid className="w-4 h-4 text-[#00ADB5]" />
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-extrabold transition-all whitespace-nowrap border shrink-0 ${
            selectedCategory === 'all'
              ? 'bg-[#0047BA] text-white border-[#0047BA] shadow-xs'
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold transition-all whitespace-nowrap border shrink-0 ${
                isSelected
                  ? 'bg-gradient-to-r from-[#00ADB5] to-[#007C8A] text-white border-[#00ADB5] shadow-xs scale-102'
                  : 'bg-slate-50 text-slate-700 border-slate-200 hover:bg-slate-100 hover:text-[#0047BA]'
              }`}
            >
