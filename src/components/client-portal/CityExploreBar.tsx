    ...
    <section id="ciudades" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      <div className="flex items-center justify-between border-b border-slate-200 pb-3">
        <h2 className="text-2xl font-extrabold text-slate-800 flex items-center gap-2">
          <span>Explorá</span>
          <span className="text-[#00ADB5]">por ciudad</span>
        </h2>
        <a href="#ciudades" className="text-xs font-bold text-[#0047BA] hover:text-[#00ADB5] flex items-center gap-1">
          ...
          return (
            <button
              ...
              className={`group flex flex-col items-center rounded-2xl overflow-hidden border transition-all text-center ${
                isSelected
                  ? 'border-[#00ADB5] ring-2 ring-[#00ADB5]/30 bg-white shadow-md'
                  : 'border-slate-200 bg-white hover:border-[#00ADB5] shadow-2xs'
              }`}
            >
              {city.isAll ? (
                <div className="h-20 sm:h-24 w-full bg-slate-50 flex items-center justify-center text-[#0047BA] group-hover:text-[#00ADB5] transition-colors">
