        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center justify-between">
          ...
          <div className="md:col-span-4 flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex items-center justify-center gap-3 text-slate-700">
              {/* Instagram */}
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-100 hover:bg-[#00ADB5] hover:text-white rounded-full transition-colors" title="Instagram">
              ...
              {/* Facebook */}
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-100 hover:bg-[#00ADB5] hover:text-white rounded-full transition-colors" title="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-100 hover:bg-[#00ADB5] hover:text-white rounded-full transition-colors" title="YouTube">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {/* TikTok */}
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-100 hover:bg-[#00ADB5] hover:text-white rounded-full transition-colors" title="TikTok">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
