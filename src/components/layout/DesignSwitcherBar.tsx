  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[9999] h-11 bg-[#0f172a] text-white text-xs px-4 shadow-2xl border-b border-slate-700 flex items-center justify-between gap-3 select-none">
      ...
      <div className="flex items-center gap-2 truncate">
        <span className="w-2.5 h-2.5 rounded-full bg-[#00E5E8] animate-pulse shrink-0" />
        <span className="font-extrabold tracking-wider uppercase flex items-center gap-1.5 text-slate-200 truncate">
          <SlidersHorizontal className="w-3.5 h-3.5 text-[#00ADB5] shrink-0" />
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        <button
          ...
          className={`px-2.5 py-1 rounded-lg font-bold flex items-center gap-1.5 transition-all text-xs cursor-pointer ${
            !isEditorial
              ? 'bg-gradient-to-r from-[#00ADB5] to-[#007C8A] text-white shadow-md ring-2 ring-cyan-400/50'
              : 'bg-slate-800 text-slate-200 hover:bg-[#00ADB5] hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`px-2.5 py-1 rounded-lg font-bold flex items-center gap-1.5 transition-all text-xs cursor-pointer ${
            isEditorial
              ? 'bg-gradient-to-r from-[#0047BA] to-[#002878] text-white shadow-md ring-2 ring-blue-400/50'
              : 'bg-slate-800 text-slate-200 hover:bg-[#0047BA] hover:text-white'
          }`}
        >
          <Newspaper className="w-3.5 h-3.5 text-[#00E5E8]" />
