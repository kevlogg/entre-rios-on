    ...
    <DynamicLayoutWrapper>
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 w-full">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-slate-500">
          ...
          <span>/</span>
          <span className="text-[#0047BA]">Sorteos ON MÁS</span>
        </div>

        {/* Hero Sorteos Card */}
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#002878] via-[#0047BA] to-[#00ADB5] text-white p-8 sm:p-12 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-md space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h2 className="text-xl font-extrabold text-[#0047BA] flex items-center gap-2">
            ...
            {isSubmitted ? (
              <div className="bg-cyan-50 border border-cyan-200 rounded-2xl p-6 text-center space-y-3 animate-in fade-in duration-300">
                ...
                <button
                  ...
                  className="text-xs font-bold text-[#0047BA] underline pt-2"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#00ADB5] to-[#007C8A] hover:from-[#00E5E8] hover:to-[#00ADB5] text-white py-3.5 rounded-2xl font-extrabold text-sm shadow-md transition-transform active:scale-98"
                >
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-semibold pt-2">
              ...
              <span>Sorteo Auditado por Entre Ríos ON MÁS Portal</span>
            </div>
          </div>
          ...
          <div className="md:col-span-5 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200">
                <span className="font-extrabold text-[#00ADB5] block">1º Premio</span>
                <p className="font-bold text-slate-800">Estancia Termal 3D/2N en Federación para 2 Personas.</p>
              </div>

              <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200">
                <span className="font-extrabold text-[#0047BA] block">2º Premio</span>
                <p className="font-bold text-slate-800">Caja Canasta de Sabores Litoraleños & Vinos Tannat.</p>
              </div>

              <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200">
                <span className="font-extrabold text-[#00ADB5] block">3º Premio</span>
