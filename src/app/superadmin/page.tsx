      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 w-full">
        ...
        <div className="bg-gradient-to-r from-[#002878] via-[#0047BA] to-[#00ADB5] rounded-3xl p-6 sm:p-10 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3 max-w-2xl">
            ...
            <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
              Entre Ríos ON MÁS: Gestión Provincial General
            </h1>

            <p className="text-sm sm:text-base text-slate-100 font-medium leading-relaxed">
              Administrá los comercios adheridos de los 17 departamentos, aprobá verificaciones B2B, publicá noticias regionales y ejecutá los Sorteos ON MÁS.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xs space-y-2">
            ...
            <p className="text-3xl font-black text-[#0047BA]">{commerces.length + 1124}</p>
            <p className="text-xs text-slate-500 font-semibold">Paraná, Colón, Concordia, etc.</p>
          </div>

          <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xs space-y-2">
            <span className="text-xs font-extrabold text-slate-400 uppercase flex items-center gap-1">
              <MessageCircle className="w-4 h-4 text-[#00ADB5]" />
              <span>Leads WhatsApp Provincia</span>
            </span>
            <p className="text-3xl font-black text-[#00ADB5]">14.890</p>
            <p className="text-xs text-[#007C8A] font-bold">+32% este mes</p>
          </div>

          <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xs space-y-2">
            <span className="text-xs font-extrabold text-slate-400 uppercase flex items-center gap-1">
              <Eye className="w-4 h-4 text-[#0B66FF]" />
          ...
          <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xs space-y-2">
            ...
            <p className="text-xs text-slate-500 font-semibold">Inscriptos en Sorteos ON MÁS</p>
          </div>
        </div>
        ...
        {/* Section 3: Sorteos ON MÁS Winner Draw Tool */}
        <section className="space-y-4">
          <RafflesManager />
        </section>
